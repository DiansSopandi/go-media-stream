            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.TrackCreateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.TrackCreateRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "maxLength": 500,
                    "example": "This is a sample track description."
                },
                "duration": {
                    "type": "integer",
                    "minimum": 0,
        ...
        "dto.UserLoginRequest": {
            ...
            "properties": {
                "email": {
                    "type": "string",
                    "example": "admin@redtech.co.id"
                },
                "password": {
                    "type": "string",
                    "example": "redtech.co.id"
                }
            }
        },
